...
import { createCustomer } from "../Listing/api.js";
...
export default function Register(): JSX.Element {
    ...
    const [civil, setCivil] = useState("S");
    ...
    const handleCreation = async () => {
        setLoading(true);
        let response = await createCustomer(
            {
                name,
                motherName,
                cpf,
    ...
    if (loading)
        ...
        return (
            ...
            >
                ...
                <Button size="sm" colorScheme={"linkedin"} marginLeft="auto" marginTop="10px" onClick={handleCreation}>
                    Salvar
                </Button>
            </VStack>
        );
